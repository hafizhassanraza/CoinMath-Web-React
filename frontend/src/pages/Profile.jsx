...
const Profile = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const profileDoc = await getDoc(doc(db, 'profiles', 'profileIdHere'));
                        ...
                        <div>
                            <div className='flex flex-col gap-8 md:flex md:flex-row lg:items-center mt-7'>
                                <div className='lg:pr-40'>
                                    ...
                                    <p className='text-[14px] text-white'>{profile.email}</p>
                                </div>
                                <div className='lg:pr-40'>
                                    <span className='text-[13px] text-white'>First Name</span>
                                    <p className='text-[14px] text-white'>{profile.firstName}</p>
                                </div>
                                <div className='lg:pr-40'>
                                    <span className='text-[13px] text-white'>Surname</span>
                                    <p className='text-[14px] text-white'>{profile.surname}</p>
                                </div>
                            </div>
                            <div className='flex flex-col gap-8 md:flex md:flex-row lg:items-center mt-4'>
                                <div className='lg:pr-40'>
                                    ...
                                    <p className='text-[14px] text-white'>{profile.phone}</p>
                                </div>
                                <div className='lg:pr-40'>
                                    <span className='text-[13px] text-white'>Referral Code</span>
                                    <p className='text-[14px] text-white'>{profile.referralCode}</p>
                                </div>
                            </div>
                        </div>
                    )}
