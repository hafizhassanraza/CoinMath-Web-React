            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    >
                        ...
                        {profileData ? (
                            <img className="w-8 h-8 rounded-full" src={profileData.profileImage} alt="user photo" />
                        ) : (
                ...
                <div className={`items-center justify-between ${isMenuOpen ? 'block' : 'hidden'} w-full md:flex md:w-auto md:order-1`} id="navbar-user">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li className={`cursor-pointer py-2 px-4 text-white rounded-lg  md:px-2 md:dark:text-blue-500 flex gap-2 items-center ${location.pathname === '/' ? 'bg-[#363636]' : 'hover:bg-[#363636]'}`} aria-current="page">
                            <MdOutlineHome className='text-xl' />
                            <Link to="/" >Home</Link>
                        </li>
                        <li className={` cursor-pointer py-2 px-3 md:py-2 flex gap-2 items-center md:px-2 md:rounded-lg text-white rounded ${location.pathname === '/token' ? 'bg-[#363636]' : 'hover:bg-[#363636]'} md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:hover:bg-[#363636] dark:border-gray-700`}>
                            <LuCoins className='text-xl' />
                            <Link to="/token" >COIN Gen</Link>
                        </li>
                        <li className={`cursor-pointer py-2 px-3 md:py-2 flex gap-2 items-center md:px-2 md:rounded-lg text-white rounded ${location.pathname === '/wallet' ? 'bg-[#363636]' : 'hover:bg-green-500'} md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:hover:bg-[#363636] dark:border-gray-700`}>
                            <IoWalletSharp className='text-xl' />
                            <Link to="/wallet" >Wallet</Link>
                        </li>
                        <li className={`cursor-pointer py-2 px-3 md:py-2 flex gap-2 items-center md:px-2 md:rounded-lg text-white rounded ${location.pathname === '/ref' ? 'bg-[#363636]' : 'hover:bg-green-500'} md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:hover:bg-[#363636] dark:border-gray-700`}>
                            <MdRoomPreferences className='text-xl' />
                            <Link to="/ref" >Referrals</Link>
                        </li>
                        <li className={`cursor-pointer py-2 px-3 md:py-2 flex gap-2 items-center md:px-2 md:rounded-lg text-white rounded ${location.pathname === '/news' ? 'bg-[#363636]' : 'hover:bg-green-500'} md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:hover:bg-[#363636] dark:border-gray-700`}>
