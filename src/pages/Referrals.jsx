        ...
        <>
            <div className='px-3 lg:px-20 mt-5'>
                <div className='rounded-b-xl overflow-hidden border border-[#262626]'>
                    ...
                    <div className='bg-[#1F1F1F] flex  gap-4 px-10 h-28'>
                        ...
                        <div className='flex justify-between  w-full  mt-2 '>
                            <div className=''>
                                <h2 className='text-white font-bold text-2xl'>My Referrals</h2>
                                <p className='text-white text-[12px] mt-1'>See how many people you've referred.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className=' bg-[#1F1F1F] text-[#ce9600] rounded-xl mt-7 py-3  px-10 border border-[#262626]'>
                    <div className='flex items-center text-[#ce9600] justify-between   hover:bg-[#262626] pr-1 pl-2 py-1 cursor-pointer rounded-lg transition-colors duration-100'>
                        ...
                        <div className=' bg-[#2c281d] rounded-2xl px-2   flex gap-2 items-center'>
                ...
                <div className='flex items-center gap-6 bg-[#1F1F1F] rounded-xl my-7 py-8 px-10 border border-[#262626]'>
                    <div className='overflow-hidden rounded-lg border border-[#262626] px-6 w-[50%] py-2'>
                    ...
                    <div className='rounded-lg border border-[#262626] px-6 w-[50%] py-2'>
