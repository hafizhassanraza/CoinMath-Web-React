        ...
        <div className="background">
            ...
            <form>
                ...
                <label className="flex items-center mt-3">
                    ...
                    <p className="text-white text-[13px]">I have read and agree to the<span className='text-gray-700 hover:underline cursor-pointer font-bold'> Privacy Policy</span></p>
                </label>
                ...
                <p className='text-sm text-center mt-2'>Already have an account? <span className='text-gray-700 hover:underline cursor-pointer font-bold'>Customer log in</span></p>
            </form>
        </div>
