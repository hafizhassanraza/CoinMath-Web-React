...
const ProfileDetail = () => {
    return (
        <div className=' md:px-52 pb-10'>
            ...
            <div className=' bg-[#1F1F1F] rounded-xl my-7  px-10 border border-[#262626]'>
                <div className=''>
                ...
                <div className='flex items-center gap-5 px-5 mx-4 py-3 my-5 rounded-xl bg-[#443919]'>
                    <div><LuLink /></div>
                ...
                <div className="mb-10 mt-4">
                    <Link to='/profile'>
                        <div className="flex items-center bg-[#CE9600] hover:bg-[#CE9600]/90 justify-center  my-3 mx-96 rounded-lg cursor-pointer  border-solid border-blueGray-200">
                            <button
